...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| Rapida 1H V1 | Rapida 1H V1 — madre | 66 | 176 | 33 | 143 | -0,33R | -0,02R | -0,31R | -0,06R | +0,27R | SELEZIONE DA RIVEDERE |
...
| SHADOW_COMBO_ADAPTIVE | Combo Adaptive — madre | 21 | 94 | 12 | 82 | 0,19R | 0,06R | +0,14R | 0,25R | +0,05R | NESSUN EDGE CHIARO |
| Rapida 1H V3 Filtered | Rapida 1H V3 Filtered — madre | 58 | 85 | 34 | 51 | 0,19R | -0,20R | +0,39R | 0,01R | -0,18R | FILTRO PAPER UTILE |
...
| SHADOW_COMBO_ADAPTIVE_MFE_TRAIL | Combo Adaptive — MFE Trail esistente | 27 | 61 | 12 | 49 | -0,55R | 0,11R | -0,66R | -0,24R | +0,32R | SELEZIONE DA RIVEDERE |
...
| SHADOW_1H_FAST_NO_PEPE_V1 | Rapida V1 — senza PEPE | 26 | 43 | 13 | 30 | -0,12R | -0,23R | +0,11R | -0,02R | +0,10R | NESSUN EDGE CHIARO |
| SHADOW_4H_WIDE | Ampia 4H | 13 | 42 | 9 | 33 | 0,25R | -0,10R | +0,35R | 0,06R | -0,19R | FILTRO PAPER UTILE |
| SHADOW_1H_FAST_V3_NO_ESPORTS_V1 | Rapida V3 — senza ESPORTS | 30 | 41 | 19 | 22 | 0,10R | -0,49R | +0,59R | -0,04R | -0,14R | FILTRO PAPER UTILE |
| SHADOW_1H_FAST_NOHIGH_CAP75_V1 | Rapida V1 — no HIGH + score <7,5 | 28 | 40 | 16 | 24 | 0,16R | -0,32R | +0,48R | -0,00R | -0,16R | FILTRO PAPER UTILE |
| SHADOW_1H_FAST_TP2_V1 | Rapida V1 — target pieno 2R | 27 | 40 | 11 | 29 | 0,27R | -0,54R | +0,81R | -0,09R | -0,37R | FILTRO PAPER UTILE |
| SHADOW_1H_FAST_V3_NOHIGH_V1 | Rapida V3 — no volatilità HIGH | 31 | 40 | 21 | 19 | 0,11R | -0,53R | +0,64R | -0,06R | -0,17R | FILTRO PAPER UTILE |
| SHADOW_DONCHIAN_1H | Benchmark Donchian breakout 1H | 18 | 40 | 11 | 29 | 0,53R | -0,22R | +0,75R | 0,20R | -0,34R | FILTRO PAPER UTILE |
| SHADOW_COMBO_ADAPTIVE_PARTIAL_1R_V1 | Combo Adaptive — parziale 1R | 11 | 38 | 6 | 32 | -0,06R | -0,32R | +0,25R | -0,25R | -0,19R | CAMPIONE INSUFFICIENTE |
...
| SHADOW_1H_FAST_V3_CAP75_V1 | Rapida V3 — score <7,5 | 23 | 36 | 15 | 21 | 0,24R | -0,46R | +0,70R | 0,05R | -0,19R | FILTRO PAPER UTILE |
| SHADOW_BOLLINGER_MR_1H | Benchmark Bollinger mean reversion 1H | 25 | 35 | 24 | 11 | 0,17R | -0,16R | +0,33R | 0,19R | +0,02R | FILTRO PAPER UTILE |
...
| SHADOW_COMBO_ADAPTIVE_RUNNER25_V1 | Combo Adaptive — 75% a 2R + runner 3R | 13 | 28 | 6 | 22 | -0,41R | -0,52R | +0,11R | -0,10R | +0,31R | CAMPIONE INSUFFICIENTE |
| SHADOW_COMBO_ADAPTIVE_TP3_V1 | Combo Adaptive — target pieno 3R | 9 | 28 | 5 | 23 | -0,28R | -0,54R | +0,26R | -0,01R | +0,27R | CAMPIONE INSUFFICIENTE |
| SHADOW_1H_FAST_V3_LONG_ONLY_V1 | Rapida V3 — Long Only | 24 | 24 | 16 | 8 | -0,28R | -0,44R | +0,16R | -0,19R | +0,09R | NESSUN EDGE CHIARO |
...
| SHADOW_1H_FAST_V3_LONG_NOHIGH_CAP75_LOCK_V1 | Rapida V3 — qualità completa + profit lock | 19 | 20 | 15 | 5 | -0,23R | -0,05R | -0,17R | -0,24R | -0,01R | CAMPIONE INSUFFICIENTE |
| SHADOW_1H_FAST_V3_LONG_NOHIGH_CAP75_V1 | Rapida V3 — Long + no HIGH + score <7,5 | 19 | 20 | 15 | 5 | -0,23R | -0,05R | -0,17R | -0,20R | +0,03R | CAMPIONE INSUFFICIENTE |
| SHADOW_SCANNER_TOP5_BTC_MFE_V1 | Top 5 + BTC — solo MFE | 11 | 20 | 5 | 15 | -0,43R | -0,19R | -0,24R | -0,48R | -0,05R | CAMPIONE INSUFFICIENTE |
| SHADOW_MASTER_ADAPTIVE_EXPANDED_V1 | Master Adaptive Expanded V1 | 7 | 19 | 5 | 14 | -0,49R | -0,39R | -0,10R | -0,65R | -0,16R | CAMPIONE INSUFFICIENTE |
| SHADOW_MASTER_ADAPTIVE_GB20_V1 | Master Adaptive Gb20 V1 | 27 | 19 | 6 | 13 | -1,05R | -0,35R | -0,69R | -0,27R | +0,78R | CAMPIONE INSUFFICIENTE |
| SHADOW_MASTER_ADAPTIVE_NO_ALT_V1 | Master Adaptive No Alt V1 | 5 | 19 | 3 | 16 | -1,08R | -0,48R | -0,61R | -1,09R | -0,01R | CAMPIONE INSUFFICIENTE |
...
| SHADOW_MASTER_ADAPTIVE_V1 | Master Adaptive V1 | 5 | 19 | 3 | 16 | -1,08R | -0,48R | -0,61R | -1,09R | -0,01R | CAMPIONE INSUFFICIENTE |
...
| SHADOW_1H_FAST_LONG_BTC_1_3_CAP75_V1 | Rapida V1 — Long + BTC 1–3 + score <7,5 | 8 | 9 | 4 | 5 | -0,39R | 0,43R | -0,83R | -0,27R | +0,12R | CAMPIONE INSUFFICIENTE |
...
| SHORT RSI 75 · leva 5× · Wide | RIDURRE / ESCLUDERE IN CHALLENGER | Asset | ETH | 8 | 25,00% | 0,51 | -1,02% | -1,20% | MEDIA |
...
| SHADOW_COMBO_ADAPTIVE_PARTIAL_1R_V1 | RIDURRE / ESCLUDERE IN CHALLENGER | Regime entrata | TREND_UP | 8 | 0,00% | 0,00 | -1,07R | -0,79R | MEDIA |
