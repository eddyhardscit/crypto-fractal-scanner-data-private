...
Generato: 2026-07-27T01:49:54+00:00

> Report esclusivamente osservativo. Non modifica strategie, rischio, capitale o ordini. Qualsiasi filtro candidato deve essere provato in un nuovo conto challenger e validato su dati futuri.

## Lettura rapida

- Trade Paper chiusi nei conti confrontati: **2106**
- Trade Shadow/Research chiusi: **3833**
- Eventi Shadow già presi dai Paper: **1082**
- Eventi Shadow saltati dai Paper: **2751**
...
| Rapida 1H V3 Filtered | Rapida 1H V3 Filtered — madre | 74 | 125 | 37 | 88 | 0,16R | 0,03R | +0,13R | 0,10R | -0,06R | NESSUN EDGE CHIARO |
...
| SHADOW_1H_FAST_NO_PEPE_V1 | Rapida V1 — senza PEPE | 42 | 83 | 17 | 66 | -0,04R | 0,01R | -0,05R | 0,12R | +0,16R | NESSUN EDGE CHIARO |
| SHADOW_1H_FAST_V3_NOHIGH_V1 | Rapida V3 — no volatilità HIGH | 49 | 80 | 27 | 53 | 0,13R | 0,02R | +0,11R | 0,06R | -0,07R | NESSUN EDGE CHIARO |
| Bilanciata 1H V3 Filtered | Bilanciata 1H V3 Filtered | 46 | 79 | 21 | 58 | 0,14R | 0,06R | +0,08R | 0,23R | +0,09R | NESSUN EDGE CHIARO |
| SHADOW_1H_FAST_NOHIGH_CAP75_V1 | Rapida V1 — no HIGH + score <7,5 | 52 | 79 | 28 | 51 | 0,08R | 0,13R | -0,06R | 0,18R | +0,10R | NESSUN EDGE CHIARO |
| SHADOW_1H_FAST_V3_NO_ESPORTS_V1 | Rapida V3 — senza ESPORTS | 48 | 79 | 25 | 54 | 0,12R | -0,05R | +0,17R | 0,07R | -0,05R | FILTRO PAPER UTILE |
| SHADOW_1H_FAST_TP2_V1 | Rapida V1 — target pieno 2R | 47 | 76 | 17 | 59 | 0,69R | -0,21R | +0,89R | 0,02R | -0,67R | FILTRO PAPER UTILE |
...
| SHADOW_1H_FAST_V3_CAP75_V1 | Rapida V3 — score <7,5 | 45 | 68 | 28 | 40 | 0,07R | 0,07R | +0,00R | 0,18R | +0,11R | NESSUN EDGE CHIARO |
| MAIN | Principale 4H | 21 | 64 | 16 | 48 | -0,09R | 0,10R | -0,19R | -0,28R | -0,18R | NESSUN EDGE CHIARO |
| SHADOW_COMBO_ADAPTIVE_PARTIAL_1R_V1 | Combo Adaptive — parziale 1R | 17 | 64 | 7 | 57 | 0,23R | -0,12R | +0,35R | -0,54R | -0,77R | CAMPIONE INSUFFICIENTE |
| SHADOW_1H_FAST_SCORE_6_75_V1 | Rapida V1 — score 6–7,5 | 48 | 58 | 31 | 27 | 0,12R | 0,15R | -0,03R | 0,14R | +0,02R | NESSUN EDGE CHIARO |
| SHADOW_DONCHIAN_1H | Benchmark Donchian breakout 1H | 26 | 58 | 19 | 39 | 0,60R | -0,41R | +1,02R | 0,36R | -0,24R | FILTRO PAPER UTILE |
| Bilanciata 1H V2 | Bilanciata 1H V2 | 35 | 54 | 21 | 33 | 0,19R | 0,21R | -0,02R | 0,06R | -0,13R | NESSUN EDGE CHIARO |
...
| SHADOW_1H_FAST_V3_LONG_ONLY_V1 | Rapida V3 — Long Only | 40 | 46 | 22 | 24 | 0,19R | -0,10R | +0,29R | -0,13R | -0,32R | FILTRO PAPER UTILE |
...
| SHADOW_1H_FAST_V3_LONG_NOHIGH_CAP75_LOCK_V1 | Rapida V3 — qualità completa + profit lock | 38 | 36 | 27 | 9 | -0,04R | 0,35R | -0,38R | -0,02R | +0,01R | PAPER SCARTA EDGE |
| SHADOW_1H_FAST_V3_LONG_NOHIGH_CAP75_V1 | Rapida V3 — Long + no HIGH + score <7,5 | 35 | 36 | 27 | 9 | -0,04R | 0,35R | -0,38R | -0,01R | +0,02R | PAPER SCARTA EDGE |
...
| SHADOW_SCANNER_TOP5_BTC_MFE_V1 | Top 5 + BTC — solo MFE | 18 | 33 | 7 | 26 | -0,47R | 0,19R | -0,66R | -0,27R | +0,20R | CAMPIONE INSUFFICIENTE |
...
| SHADOW_MASTER_ADAPTIVE_GB20_V1 | Master Adaptive Gb20 V1 | 46 | 31 | 9 | 22 | -1,04R | 0,19R | -1,23R | -0,13R | +0,91R | PAPER SCARTA EDGE |
| SHADOW_MASTER_ADAPTIVE_V1 | Master Adaptive V1 | 9 | 31 | 4 | 27 | -0,32R | -0,15R | -0,17R | -0,72R | -0,40R | CAMPIONE INSUFFICIENTE |
| SHADOW_COMBO_ADAPTIVE_REGIME_V1 | Combo Adaptive — Trend/Transition | 10 | 29 | 9 | 20 | -0,07R | -0,77R | +0,70R | -0,04R | +0,03R | SELEZIONE POSITIVA |
| SHADOW_MASTER_ADAPTIVE_NO_ALT_V1 | Master Adaptive No Alt V1 | 9 | 29 | 4 | 25 | -0,32R | -0,08R | -0,24R | -0,71R | -0,39R | CAMPIONE INSUFFICIENTE |
| SHADOW_SCANNER_TOP5_BTC_BTC_LE3_V1 | Top 5 + BTC — BTC≤3 | 10 | 29 | 6 | 23 | 1,07R | -0,19R | +1,26R | -0,05R | -1,12R | CAMPIONE INSUFFICIENTE |
| SHADOW_MASTER_ADAPTIVE_STRICT3_V1 | Master Adaptive Strict3 V1 | 19 | 27 | 13 | 14 | -0,35R | 0,03R | -0,38R | -0,51R | -0,16R | SELEZIONE DA RIVEDERE |
...
| SHADOW_1H_FAST_LONG_BTC_1_3_CAP75_V1 | Rapida V1 — Long + BTC 1–3 + score <7,5 | 16 | 17 | 11 | 6 | 0,19R | 0,61R | -0,42R | 0,10R | -0,09R | CAMPIONE INSUFFICIENTE |
| SHADOW_1H_FAST_NOHIGH_CAP75_SHORT_ONLY_V1 | FAST NoHigh <7,5 · SHORT only | 15 | 15 | 6 | 9 | -0,21R | 0,89R | -1,10R | 0,33R | +0,54R | CAMPIONE INSUFFICIENTE |
...
| EVO_CAND_SHADOW_1H_FAST_V3_NOHIGH_V1_TP_R200_8346046b | n/a | 0 | 10 | 0 | 10 | 0,00R | 0,45R | -0,45R | 0,00R | 0,00R | CAMPIONE INSUFFICIENTE |
| EVO_CAND_SHADOW_1H_FAST_V3_TP_R200_3ee5afb4 | n/a | 0 | 10 | 0 | 10 | 0,00R | 0,45R | -0,45R | 0,00R | 0,00R | CAMPIONE INSUFFICIENTE |
| RSI_EXTREME_LONG_15M | Scalp RSI Long 25 · prudente · 5x | 5 | 10 | 5 | 5 | -0,02R | -1,06R | +1,04R | -0,46R | -0,44R | CAMPIONE INSUFFICIENTE |
| EVO_CAND_SHADOW_1H_FAST_V3_CAP75_V1_TP_R200_86882aa9 | n/a | 0 | 8 | 0 | 8 | 0,00R | 0,44R | -0,44R | 0,00R | 0,00R | CAMPIONE INSUFFICIENTE |
| EVO_CAND_SHADOW_1H_FAST_V3_NO_ESPORTS_MFE_LOCK_TP_R200_6b7c560f | n/a | 0 | 8 | 0 | 8 | 0,00R | 0,81R | -0,81R | 0,00R | 0,00R | CAMPIONE INSUFFICIENTE |
| EVO_CAND_SHADOW_1H_FAST_V3_NO_ESPORTS_V1_TP_R200_68f866e1 | n/a | 0 | 8 | 0 | 8 | 0,00R | 0,44R | -0,44R | 0,00R | 0,00R | CAMPIONE INSUFFICIENTE |
| EVO_CAND_SHADOW_1H_FAST_V3_LONG_NOHIGH_CAP75_L_TP_R200_903364ad | n/a | 0 | 7 | 0 | 7 | 0,00R | 0,22R | -0,22R | 0,00R | 0,00R | CAMPIONE INSUFFICIENTE |
| EVO_CAND_SHADOW_1H_FAST_V3_LONG_NOHIGH_CAP75_V_TP_R200_051501d0 | n/a | 0 | 7 | 0 | 7 | 0,00R | 0,22R | -0,22R | 0,00R | 0,00R | CAMPIONE INSUFFICIENTE |
| EVO_CAND_SHADOW_1H_FAST_V3_LONG_ONLY_V1_TP_R200_751e55c4 | n/a | 0 | 7 | 0 | 7 | 0,00R | 0,22R | -0,22R | 0,00R | 0,00R | CAMPIONE INSUFFICIENTE |
| EVO_CAND_SHADOW_1H_FAST_V3_NO_ESPORTS_LONG_ONL_TP_R200_7bbb9481 | n/a | 0 | 7 | 0 | 7 | 0,00R | 1,08R | -1,08R | 0,00R | 0,00R | CAMPIONE INSUFFICIENTE |
...
| EVO_CAND_SHADOW_1H_FAST_V3_NOHIGH_REGIME_GUARD_TP_R200_934590ed | n/a | 0 | 6 | 0 | 6 | 0,00R | 0,94R | -0,94R | 0,00R | 0,00R | CAMPIONE INSUFFICIENTE |
...
| EVO_CAND_SHADOW_1H_FAST_V3_NO_ESPORTS_STRESS_G_TP_R200_89ab3f19 | n/a | 0 | 4 | 0 | 4 | 0,00R | 1,17R | -1,17R | 0,00R | 0,00R | CAMPIONE INSUFFICIENTE |
...
| SHADOW_1H_FAST_V3_NO_ESPORTS_MFE_LOCK_V1 | Rapida V3 senza ESPORTS — MFE Lock | 23 | 0 | 0 | 0 | 0,00R | 0,00R | 0,00R | 0,28R | +0,28R | CAMPIONE INSUFFICIENTE |
...
| SHADOW_1H_FAST_V3_LONG_ONLY_V1 | RIDURRE / ESCLUDERE IN CHALLENGER | Regime entrata | ALT_ROTATION_DOWN | 8 | 0,00% | 0,00 | -1,03R | -1,07R | MEDIA |
