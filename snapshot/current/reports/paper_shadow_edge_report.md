...
Generato: 2026-07-20T15:36:21+00:00

> Report esclusivamente osservativo. Non modifica strategie, rischio, capitale o ordini. Qualsiasi filtro candidato deve essere provato in un nuovo conto challenger e validato su dati futuri.

## Lettura rapida

- Trade Paper chiusi nei conti confrontati: **455**
- Trade Shadow/Research chiusi: **955**
- Eventi Shadow già presi dai Paper: **302**
- Eventi Shadow saltati dai Paper: **653**
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| Rapida 1H V1 | Rapida 1H V1 | 43 | 116 | 25 | 91 | -0,29R | 0,00R | -0,29R | 0,02R | +0,31R | SELEZIONE DA RIVEDERE |
| Bilanciata 1H V1 | Bilanciata 1H V1 | 20 | 102 | 6 | 96 | -0,20R | 0,03R | -0,23R | 0,08R | +0,28R | CAMPIONE INSUFFICIENTE |
...
| Rapida 1H V3 Filtered | Rapida 1H V3 Filtered | 33 | 29 | 21 | 8 | 0,14R | 0,19R | -0,04R | -0,10R | -0,25R | NESSUN EDGE CHIARO |
...
| Bilanciata 1H V3 Filtered | Bilanciata 1H V3 Filtered | 21 | 23 | 14 | 9 | 0,46R | 0,30R | +0,16R | 0,23R | -0,23R | NESSUN EDGE CHIARO |
| SHADOW_BOLLINGER_MR_1H | Benchmark Bollinger mean reversion 1H | 14 | 22 | 14 | 8 | -0,01R | -0,44R | +0,44R | 0,23R | +0,24R | SELEZIONE POSITIVA |
| SHADOW_COMBO_ADAPTIVE_MFE_TRAIL | Combo Adaptive MFE Trail | 20 | 22 | 8 | 14 | -0,66R | 0,89R | -1,55R | -0,30R | +0,36R | PAPER SCARTA EDGE |
...
| Rapida 1H V1 | RIDURRE / ESCLUDERE IN CHALLENGER | Volatilità entrata | HIGH | 22 | 9,09% | 0,13 | -0,87R | -0,81R | ALTA |
...
| Rapida 1H V3 Filtered | RIDURRE / ESCLUDERE IN CHALLENGER | Fascia score | ≥7 | 8 | 25,00% | 0,47 | -0,42R | -0,58R | MEDIA |
