...
Generato: 2026-08-04T02:50:48+00:00
...
- Trade Shadow/Research chiusi: **12000**
- Eventi Shadow già presi dai Paper: **1589**
- Eventi Shadow saltati dai Paper: **10411**
...
| Rapida 1H V3 Filtered | Rapida 1H V3 Filtered — madre | 103 | 331 | 55 | 276 | 0,01R | -0,13R | +0,14R | 0,05R | +0,05R | NESSUN EDGE CHIARO |
| SHADOW_1H_FAST_NO_PEPE_V1 | Rapida V1 — senza PEPE | 72 | 313 | 34 | 279 | -0,06R | -0,16R | +0,10R | 0,12R | +0,18R | NESSUN EDGE CHIARO |
| SHADOW_1H_FAST_TP2_V1 | Rapida V1 — target pieno 2R | 79 | 291 | 34 | 257 | 0,28R | -0,20R | +0,48R | -0,02R | -0,30R | FILTRO PAPER UTILE |
| SHADOW_1H_FAST_V3_NO_ESPORTS_V1 | Rapida V3 — senza ESPORTS | 77 | 284 | 43 | 241 | -0,05R | -0,17R | +0,12R | 0,02R | +0,07R | NESSUN EDGE CHIARO |
...
| SHADOW_1H_FAST_V3_NOHIGH_V1 | Rapida V3 — no volatilità HIGH | 62 | 253 | 33 | 220 | 0,05R | -0,14R | +0,19R | 0,03R | -0,01R | FILTRO PAPER UTILE |
| SHADOW_1H_FAST_NOHIGH_CAP75_V1 | Rapida V1 — no HIGH + score <7,5 | 64 | 240 | 35 | 205 | 0,20R | -0,08R | +0,28R | 0,17R | -0,03R | FILTRO PAPER UTILE |
| SHADOW_1H_FAST_V3_CAP75_V1 | Rapida V3 — score <7,5 | 68 | 231 | 45 | 186 | -0,08R | -0,08R | +0,00R | 0,05R | +0,13R | NESSUN EDGE CHIARO |
| SHADOW_EMA_TREND_1H | Benchmark trend following EMA 1H | 46 | 229 | 14 | 215 | -0,42R | -0,08R | -0,34R | -0,17R | +0,25R | SELEZIONE DA RIVEDERE |
...
| SHADOW_MASTER_ADAPTIVE_GB20_V1 | Master Adaptive Gb20 V1 | 54 | 195 | 12 | 183 | -0,70R | 0,12R | -0,82R | -0,14R | +0,56R | SELEZIONE DA RIVEDERE |
| EVO_CAND_SHADOW_1H_FAST_V3_TP_R200_3ee5afb4 | n/a | 0 | 192 | 0 | 192 | 0,00R | -0,19R | +0,19R | 0,00R | 0,00R | CAMPIONE INSUFFICIENTE |
| SHADOW_1H_FAST_SCORE_6_75_V1 | Rapida V1 — score 6–7,5 | 75 | 192 | 52 | 140 | 0,01R | -0,06R | +0,07R | 0,09R | +0,08R | NESSUN EDGE CHIARO |
...
| SHADOW_1H_FAST_NOHIGH_CAP75_SHORT_ONLY_V1 | FAST NoHigh <7,5 · SHORT only | 28 | 173 | 15 | 158 | -0,01R | -0,08R | +0,07R | 0,19R | +0,20R | NESSUN EDGE CHIARO |
...
| EVO_CAND_SHADOW_1H_FAST_V3_CAP75_V1_TP_R200_86882aa9 | n/a | 0 | 154 | 0 | 154 | 0,00R | -0,16R | +0,16R | 0,00R | 0,00R | CAMPIONE INSUFFICIENTE |
| SHADOW_1H_FAST_V3_LONG_ONLY_V1 | Rapida V3 — Long Only | 56 | 152 | 31 | 121 | -0,06R | -0,08R | +0,03R | -0,21R | -0,16R | NESSUN EDGE CHIARO |
...
| EVO_CAND_SHADOW_1H_FAST_V3_CAP75_V1_TP_R250_3b03ece1 | n/a | 0 | 128 | 0 | 128 | 0,00R | -0,28R | +0,28R | 0,00R | 0,00R | CAMPIONE INSUFFICIENTE |
...
| SHADOW_1H_FAST_V3_LONG_NOHIGH_CAP75_V1 | Rapida V3 — Long + no HIGH + score <7,5 | 44 | 118 | 33 | 85 | 0,00R | -0,05R | +0,05R | -0,07R | -0,08R | NESSUN EDGE CHIARO |
| SHADOW_MASTER_ADAPTIVE_EXPANDED_V1 | Master Adaptive Expanded V1 | 22 | 118 | 11 | 107 | 0,20R | -0,09R | +0,29R | -0,10R | -0,30R | FILTRO PAPER UTILE |
...
| SHADOW_MASTER_ADAPTIVE_V1 | Master Adaptive V1 | 19 | 113 | 8 | 105 | -0,06R | -0,10R | +0,04R | -0,26R | -0,21R | NESSUN EDGE CHIARO |
...
| SHADOW_MASTER_ADAPTIVE_NO_ALT_V1 | Master Adaptive No Alt V1 | 19 | 105 | 7 | 98 | 0,09R | -0,12R | +0,21R | -0,26R | -0,35R | CAMPIONE INSUFFICIENTE |
...
| SHADOW_MASTER_ADAPTIVE_RUNNER25_V1 | Master Adaptive Runner25 V1 | 21 | 101 | 9 | 92 | 0,06R | -0,12R | +0,18R | -0,19R | -0,25R | FILTRO PAPER UTILE |
...
| SHADOW_1H_FAST_LONG_BTC_1_3_CAP75_V1 | Rapida V1 — Long + BTC 1–3 + score <7,5 | 25 | 62 | 21 | 41 | 0,18R | -0,09R | +0,27R | -0,05R | -0,22R | FILTRO PAPER UTILE |
