...
Generato: 2026-08-03T07:45:01+00:00
...
- Trade Shadow/Research chiusi: **11335**
- Eventi Shadow già presi dai Paper: **1585**
- Eventi Shadow saltati dai Paper: **9750**
...
| Forza relativa 1H V1 | Forza relativa 1H V1 | 51 | 268 | 15 | 253 | -0,16R | -0,10R | -0,06R | -0,23R | -0,07R | NESSUN EDGE CHIARO |
| SHADOW_1H_FAST_V3_NO_ESPORTS_V1 | Rapida V3 — senza ESPORTS | 77 | 268 | 43 | 225 | -0,05R | -0,15R | +0,09R | 0,02R | +0,07R | NESSUN EDGE CHIARO |
| SHADOW_COMBO_ADAPTIVE | Combo Adaptive — madre | 40 | 262 | 17 | 245 | 0,40R | -0,01R | +0,41R | 0,19R | -0,22R | FILTRO PAPER UTILE |
| SHADOW_COMBO_ADAPTIVE_MFE_TRAIL | Combo Adaptive — MFE Trail esistente | 50 | 255 | 19 | 236 | -0,29R | 0,03R | -0,32R | -0,28R | +0,01R | SELEZIONE DA RIVEDERE |
...
| SHADOW_COMBO_ADAPTIVE_PARTIAL_1R_V1 | Combo Adaptive — parziale 1R | 41 | 203 | 16 | 187 | 0,39R | -0,07R | +0,46R | -0,23R | -0,62R | FILTRO PAPER UTILE |
...
| SHADOW_MASTER_ADAPTIVE_GB20_V1 | Master Adaptive Gb20 V1 | 54 | 181 | 12 | 169 | -0,70R | 0,14R | -0,85R | -0,14R | +0,56R | SELEZIONE DA RIVEDERE |
...
| SHADOW_COMBO_SCANNER | Combo Scanner | 50 | 146 | 21 | 125 | 0,33R | 0,11R | +0,22R | -0,14R | -0,47R | SELEZIONE POSITIVA |
...
| SHADOW_SCANNER_TOP5_BTC | Scanner Top 5 + forza BTC 1H | 41 | 140 | 24 | 116 | 0,19R | 0,12R | +0,07R | 0,06R | -0,13R | NESSUN EDGE CHIARO |
...
| SHADOW_SCANNER_TOP5_BTC_MFE_V1 | Top 5 + BTC — solo MFE | 34 | 118 | 14 | 104 | -0,21R | 0,09R | -0,30R | -0,27R | -0,06R | SELEZIONE DA RIVEDERE |
| SHADOW_4H_WIDE | Ampia 4H | 25 | 116 | 15 | 101 | 0,06R | -0,15R | +0,21R | -0,10R | -0,16R | FILTRO PAPER UTILE |
...
| SHADOW_COMBO_ADAPTIVE_LONG_ONLY_V1 | Combo Adaptive — Long Only | 20 | 109 | 9 | 100 | 0,41R | -0,09R | +0,50R | -0,05R | -0,46R | FILTRO PAPER UTILE |
...
| SHADOW_MASTER_ADAPTIVE_RUNNER25_V1 | Master Adaptive Runner25 V1 | 21 | 97 | 9 | 88 | 0,06R | -0,11R | +0,18R | -0,19R | -0,25R | FILTRO PAPER UTILE |
| SHADOW_SCANNER_TOP5_BTC_BTC_LE3_V1 | Top 5 + BTC — BTC≤3 | 22 | 96 | 12 | 84 | 0,27R | -0,07R | +0,34R | -0,24R | -0,51R | FILTRO PAPER UTILE |
...
| SHADOW_SCANNER_TOP5_BTC_RUNNER25_V1 | Top 5 + BTC — 75% a 2,2R + runner 3R | 30 | 91 | 11 | 80 | 0,59R | -0,08R | +0,68R | -0,24R | -0,83R | FILTRO PAPER UTILE |
| SHADOW_SCANNER_TOP5_BTC_GUARD_V1 | Top 5 + BTC — Guard | 24 | 88 | 12 | 76 | 0,02R | 0,06R | -0,04R | -0,34R | -0,36R | NESSUN EDGE CHIARO |
| SHADOW_SCANNER_TOP5_BTC_TP3_V1 | Top 5 + BTC — target pieno 3R | 26 | 88 | 9 | 79 | 0,07R | 0,02R | +0,05R | -0,25R | -0,31R | NESSUN EDGE CHIARO |
...
| SHADOW_SCANNER_TOP5_BTC_GUARD_BTC_LE3_V1 | Top 5 + BTC — Guard + BTC≤3 | 19 | 83 | 8 | 75 | 0,02R | 0,07R | -0,05R | -0,20R | -0,23R | NESSUN EDGE CHIARO |
