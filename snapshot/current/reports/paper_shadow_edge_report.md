...
Generato: 2026-08-03T12:46:26+00:00
...
- Trade Shadow/Research chiusi: **11498**
- Eventi Shadow già presi dai Paper: **1587**
- Eventi Shadow saltati dai Paper: **9911**
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| Bilanciata 1H V1 | Bilanciata 1H V1 | 75 | 343 | 19 | 324 | 0,08R | -0,06R | +0,14R | 0,04R | -0,04R | NESSUN EDGE CHIARO |
...
| SHADOW_COMBO_ADAPTIVE | Combo Adaptive — madre | 40 | 264 | 17 | 247 | 0,40R | -0,02R | +0,42R | 0,19R | -0,22R | FILTRO PAPER UTILE |
| SHADOW_COMBO_ADAPTIVE_MFE_TRAIL | Combo Adaptive — MFE Trail esistente | 50 | 257 | 19 | 238 | -0,29R | 0,02R | -0,31R | -0,28R | +0,01R | SELEZIONE DA RIVEDERE |
...
| SHADOW_COMBO_ADAPTIVE_PARTIAL_1R_V1 | Combo Adaptive — parziale 1R | 41 | 205 | 16 | 189 | 0,39R | -0,08R | +0,47R | -0,23R | -0,62R | FILTRO PAPER UTILE |
...
| SHADOW_SCANNER_TOP5_LONG | Scanner Top 5 Long 1H | 50 | 160 | 25 | 135 | 0,27R | 0,05R | +0,22R | 0,14R | -0,14R | SELEZIONE POSITIVA |
...
| SHADOW_COMBO_SCANNER | Combo Scanner | 50 | 148 | 21 | 127 | 0,33R | 0,09R | +0,24R | -0,14R | -0,47R | SELEZIONE POSITIVA |
...
| SHADOW_SCANNER_TOP5_BTC | Scanner Top 5 + forza BTC 1H | 41 | 142 | 24 | 118 | 0,19R | 0,10R | +0,09R | 0,06R | -0,13R | NESSUN EDGE CHIARO |
...
| Bilanciata 1H V2 | Bilanciata 1H V2 | 41 | 122 | 24 | 98 | 0,16R | 0,04R | +0,12R | 0,14R | -0,02R | NESSUN EDGE CHIARO |
...
| SHADOW_SCANNER_TOP5_BTC_MFE_V1 | Top 5 + BTC — solo MFE | 34 | 120 | 14 | 106 | -0,21R | 0,07R | -0,28R | -0,27R | -0,06R | SELEZIONE DA RIVEDERE |
...
| SHADOW_COMBO_ADAPTIVE_LONG_ONLY_V1 | Combo Adaptive — Long Only | 20 | 111 | 9 | 102 | 0,41R | -0,11R | +0,52R | -0,05R | -0,46R | FILTRO PAPER UTILE |
...
| SHADOW_SCANNER_TOP5_BTC_GUARD_MFE_V1 | Top 5 + BTC — Guard + MFE | 41 | 106 | 19 | 87 | 0,09R | 0,08R | +0,02R | -0,25R | -0,34R | NESSUN EDGE CHIARO |
...
| SHADOW_SCANNER_TOP5_BTC_GUARD_BTC_LE3_MFE_V1 | Top 5 + BTC — Guard + BTC≤3 + MFE | 34 | 101 | 13 | 88 | 0,20R | 0,06R | +0,13R | -0,19R | -0,39R | NESSUN EDGE CHIARO |
...
| SHADOW_SCANNER_TOP5_BTC_BTC_LE3_V1 | Top 5 + BTC — BTC≤3 | 22 | 98 | 12 | 86 | 0,27R | -0,09R | +0,36R | -0,24R | -0,51R | FILTRO PAPER UTILE |
...
| SHADOW_SCANNER_TOP5_BTC_RUNNER25_V1 | Top 5 + BTC — 75% a 2,2R + runner 3R | 30 | 93 | 11 | 82 | 0,59R | -0,10R | +0,70R | -0,24R | -0,83R | FILTRO PAPER UTILE |
| SHADOW_SCANNER_TOP5_BTC_GUARD_V1 | Top 5 + BTC — Guard | 24 | 90 | 12 | 78 | 0,02R | 0,03R | -0,01R | -0,34R | -0,36R | NESSUN EDGE CHIARO |
| SHADOW_SCANNER_TOP5_BTC_TP3_V1 | Top 5 + BTC — target pieno 3R | 26 | 90 | 9 | 81 | 0,07R | -0,01R | +0,07R | -0,25R | -0,31R | NESSUN EDGE CHIARO |
...
| SHADOW_SCANNER_TOP5_BTC_GUARD_BTC_LE3_V1 | Top 5 + BTC — Guard + BTC≤3 | 19 | 85 | 8 | 77 | 0,02R | 0,04R | -0,02R | -0,20R | -0,23R | NESSUN EDGE CHIARO |
| SHADOW_SCANNER_TOP15_LONG | Scanner Top15 Long | 22 | 81 | 8 | 73 | 0,60R | -0,13R | +0,72R | -0,38R | -0,98R | FILTRO PAPER UTILE |
| SHADOW_SCANNER_TOP20_LONG | Scanner Top20 Long | 22 | 81 | 8 | 73 | 0,60R | -0,13R | +0,72R | -0,38R | -0,98R | FILTRO PAPER UTILE |
...
| SHADOW_SCANNER_TOP10_LONG | Scanner Top10 Long | 22 | 80 | 8 | 72 | 0,60R | -0,11R | +0,71R | -0,38R | -0,98R | FILTRO PAPER UTILE |
