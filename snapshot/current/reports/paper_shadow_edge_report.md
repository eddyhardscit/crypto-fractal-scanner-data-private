...
Generato: 2026-07-26T06:43:00+00:00

> Report esclusivamente osservativo. Non modifica strategie, rischio, capitale o ordini. Qualsiasi filtro candidato deve essere provato in un nuovo conto challenger e validato su dati futuri.

## Lettura rapida

- Trade Paper chiusi nei conti confrontati: **1876**
- Trade Shadow/Research chiusi: **3476**
- Eventi Shadow già presi dai Paper: **1005**
- Eventi Shadow saltati dai Paper: **2471**
- Profili con filtro Paper utile: **5**
- Profili in cui il Paper potrebbe scartare edge: **4**
- Profili con campione ancora insufficiente: **99**
...
| Rapida 1H V3 Filtered | Rapida 1H V3 Filtered — madre | 73 | 112 | 37 | 75 | 0,16R | -0,01R | +0,17R | 0,09R | -0,07R | FILTRO PAPER UTILE |
...
| SHADOW_SCANNER_TOP5_LONG | Scanner Top 5 Long 1H | 33 | 80 | 16 | 64 | 0,14R | 0,24R | -0,10R | 0,52R | +0,38R | NESSUN EDGE CHIARO |
| Bilanciata 1H V3 Filtered | Bilanciata 1H V3 Filtered | 42 | 76 | 20 | 56 | 0,15R | 0,10R | +0,05R | 0,27R | +0,12R | NESSUN EDGE CHIARO |
| SHADOW_1H_FAST_NO_PEPE_V1 | Rapida V1 — senza PEPE | 41 | 72 | 17 | 55 | -0,04R | -0,01R | -0,03R | 0,12R | +0,16R | NESSUN EDGE CHIARO |
| SHADOW_1H_FAST_NOHIGH_CAP75_V1 | Rapida V1 — no HIGH + score <7,5 | 46 | 68 | 25 | 43 | 0,12R | 0,12R | -0,01R | 0,21R | +0,09R | NESSUN EDGE CHIARO |
| SHADOW_1H_FAST_V3_NO_ESPORTS_V1 | Rapida V3 — senza ESPORTS | 47 | 68 | 25 | 43 | 0,12R | -0,08R | +0,20R | 0,05R | -0,08R | FILTRO PAPER UTILE |
| SHADOW_COMBO_SCANNER | Combo Scanner | 29 | 68 | 13 | 55 | 0,28R | 0,30R | -0,02R | 0,22R | -0,06R | NESSUN EDGE CHIARO |
| SHADOW_1H_FAST_V3_NOHIGH_V1 | Rapida V3 — no volatilità HIGH | 48 | 67 | 27 | 40 | 0,13R | -0,07R | +0,20R | 0,03R | -0,10R | FILTRO PAPER UTILE |
| SHADOW_SCANNER_TOP5_BTC | Scanner Top 5 + forza BTC 1H | 25 | 66 | 14 | 52 | 0,40R | 0,26R | +0,14R | 0,46R | +0,07R | NESSUN EDGE CHIARO |
| SHADOW_1H_FAST_TP2_V1 | Rapida V1 — target pieno 2R | 43 | 65 | 15 | 50 | 0,52R | -0,21R | +0,73R | 0,05R | -0,47R | FILTRO PAPER UTILE |
| MAIN | Principale 4H | 19 | 58 | 15 | 43 | -0,03R | 0,09R | -0,12R | -0,10R | -0,07R | NESSUN EDGE CHIARO |
| SHADOW_1H_FAST_V3_CAP75_V1 | Rapida V3 — score <7,5 | 39 | 57 | 23 | 34 | 0,11R | 0,04R | +0,06R | 0,20R | +0,09R | NESSUN EDGE CHIARO |
...
| SHADOW_DONCHIAN_1H | Benchmark Donchian breakout 1H | 24 | 52 | 16 | 36 | 0,70R | -0,38R | +1,08R | 0,42R | -0,28R | FILTRO PAPER UTILE |
| Bilanciata 1H V2 | Bilanciata 1H V2 | 32 | 51 | 20 | 31 | 0,10R | 0,29R | -0,19R | 0,15R | +0,05R | PAPER SCARTA EDGE |
| SHADOW_1H_FAST_SCORE_6_75_V1 | Rapida V1 — score 6–7,5 | 44 | 49 | 26 | 23 | 0,26R | 0,14R | +0,12R | 0,19R | -0,07R | NESSUN EDGE CHIARO |
...
| SHADOW_BOLLINGER_MR_1H | Benchmark Bollinger mean reversion 1H | 34 | 44 | 27 | 17 | 0,03R | -0,04R | +0,07R | -0,07R | -0,10R | NESSUN EDGE CHIARO |
...
| SHADOW_1H_FAST_V3_LONG_ONLY_V1 | Rapida V3 — Long Only | 32 | 36 | 19 | 17 | -0,00R | -0,16R | +0,16R | -0,04R | -0,04R | NESSUN EDGE CHIARO |
...
| SHADOW_1H_FAST_V3_LONG_NOHIGH_CAP75_LOCK_V1 | Rapida V3 — qualità completa + profit lock | 29 | 28 | 22 | 6 | -0,03R | 0,20R | -0,23R | 0,01R | +0,04R | CAMPIONE INSUFFICIENTE |
| SHADOW_1H_FAST_V3_LONG_NOHIGH_CAP75_V1 | Rapida V3 — Long + no HIGH + score <7,5 | 28 | 28 | 22 | 6 | -0,03R | 0,20R | -0,23R | 0,02R | +0,05R | CAMPIONE INSUFFICIENTE |
...
| SHADOW_MASTER_ADAPTIVE_NO_ALT_V1 | Master Adaptive No Alt V1 | 7 | 28 | 3 | 25 | -1,08R | -0,08R | -1,01R | -0,21R | +0,87R | CAMPIONE INSUFFICIENTE |
...
| SHADOW_SCANNER_TOP5_BTC_BTC_LE3_V1 | Top 5 + BTC — BTC≤3 | 8 | 25 | 4 | 21 | 0,52R | -0,11R | +0,64R | 0,54R | +0,02R | CAMPIONE INSUFFICIENTE |
| SHADOW_SCANNER_TOP5_BTC_GUARD_MFE_V1 | Top 5 + BTC — Guard + MFE | 24 | 23 | 10 | 13 | -0,08R | -0,04R | -0,04R | -0,12R | -0,05R | NESSUN EDGE CHIARO |
| SHADOW_SCANNER_TOP5_BTC_GUARD_V1 | Top 5 + BTC — Guard | 10 | 23 | 6 | 17 | -0,52R | 0,11R | -0,63R | 0,11R | +0,62R | CAMPIONE INSUFFICIENTE |
| SHADOW_MASTER_ADAPTIVE_RUNNER25_V1 | Master Adaptive Runner25 V1 | 9 | 21 | 5 | 16 | 0,54R | -0,29R | +0,83R | -0,07R | -0,61R | CAMPIONE INSUFFICIENTE |
| SHADOW_SCANNER_TOP5_BTC_GUARD_BTC_LE3_MFE_V1 | Top 5 + BTC — Guard + BTC≤3 + MFE | 21 | 20 | 6 | 14 | 0,59R | -0,11R | +0,69R | -0,03R | -0,62R | CAMPIONE INSUFFICIENTE |
...
| SHADOW_COMBO_ADAPTIVE_QUALITY7_V1 | Combo Adaptive — Quality7 | 14 | 16 | 9 | 7 | 0,28R | -0,17R | +0,45R | 0,21R | -0,07R | CAMPIONE INSUFFICIENTE |
...
| SHADOW_1H_FAST_NOHIGH_CAP75_SHORT_ONLY_V1 | FAST NoHigh <7,5 · SHORT only | 8 | 6 | 3 | 3 | -0,23R | 1,47R | -1,70R | 0,62R | +0,85R | CAMPIONE INSUFFICIENTE |
...
| EVO_CAND_SHADOW_1H_FAST_V3_NOHIGH_V1_TP_R200_8346046b | n/a | 0 | 3 | 0 | 3 | 0,00R | -0,04R | +0,04R | 0,00R | 0,00R | CAMPIONE INSUFFICIENTE |
...
| EVO_CAND_SHADOW_1H_FAST_V3_NO_ESPORTS_V1_TP_R200_68f866e1 | n/a | 0 | 3 | 0 | 3 | 0,00R | -0,04R | +0,04R | 0,00R | 0,00R | CAMPIONE INSUFFICIENTE |
| EVO_CAND_SHADOW_1H_FAST_V3_TP_R200_3ee5afb4 | n/a | 0 | 3 | 0 | 3 | 0,00R | -0,04R | +0,04R | 0,00R | 0,00R | CAMPIONE INSUFFICIENTE |
...
| EVO_CAND_SHADOW_1H_FAST_V3_LONG_ONLY_V1_TP_R200_751e55c4 | n/a | 0 | 2 | 0 | 2 | 0,00R | 0,45R | -0,45R | 0,00R | 0,00R | CAMPIONE INSUFFICIENTE |
...
| SHADOW_1H_BALANCED_LONG_NO_RHV_V1 | Bilanciata 1H — LONG senza Range High Vol | 6 | 0 | 0 | 0 | 0,00R | 0,00R | 0,00R | 0,29R | +0,29R | CAMPIONE INSUFFICIENTE |
...
| SHADOW_1H_FAST_SCORE_6_75_COST_AWARE_V1 | Rapida score 6–7,5 — Cost Aware | 8 | 0 | 0 | 0 | 0,00R | 0,00R | 0,00R | 0,96R | +0,96R | CAMPIONE INSUFFICIENTE |
| SHADOW_1H_FAST_SCORE_6_75_NO_TREND_UP_V1 | Rapida score 6–7,5 — senza Trend Up | 11 | 0 | 0 | 0 | 0,00R | 0,00R | 0,00R | 0,60R | +0,60R | CAMPIONE INSUFFICIENTE |
